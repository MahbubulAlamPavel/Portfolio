...
<body>
    <section class="header">
        <nav class="navbar navbar-expand-sm navbar-light fixed-top">
            <div class="container">
                <a class="navbar-brand text-white" href="#">Portfo<span class="typing"></span></a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12  paragraph">
                        ...
                        <h5>And I'm a <span class="typing1"></span></h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-5 profile">
                    <img src="../img/picture1.jpg" class="img-fluid" alt="" />
                </div>
                <div class="col-md-7 about-me">
                    <h4 class="font-weight-bold">I'm Pavel and I'm a <span class="typing2"></span>
                    </h4>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 profile">
                    <h4 class="text-white font-weight-bold">Get in Touch</h4>
                    <h6 class="text-white">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                        Dignissimos harum corporis fuga corrupti. Doloribus quis soluta nesciunt veritatis vitae nobis?
                    </h6>
                    <ul class="social">
                        <a href="https://www.facebook.com/pavel.khan.71/"><i id="social-fb"
                                class="fa fa-facebook-square fa-3x social"></i></a>
                        <a href="https://www.linkedin.com/in/mahbubul-alam-pavel-888202189/"><i id="social-linkin"
                                class="fa fa-linkedin-square fa-3x social p-2"></i></a>
                        <a href="https://github.com/MahbubulAlamPavel"><i id="social-git"
    ...
    <footer class="page-footer font-small bg-secondary">
        ...
        <div class="footer-copyright text-center py-3">Created By
            <a href="#" class="text-warning">Mahbubul Alam Pavel</a> | © 2020 All rights reserved.
        </div>
        <!-- Copyright -->
